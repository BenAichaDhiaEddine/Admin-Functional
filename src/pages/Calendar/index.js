...
import frLocale from '@fullcalendar/core/locales/ar-tn';
//Import Breadcrumb
import Breadcrumbs from '../../components/Common/Breadcrumb';

const DefaultEvents = [{
    id: 1,
    title: 'لجنة الشؤون الإدارية',
...
{
    id: 3,
    title: 'لجنة مراجعة المعاليم',
    start: new Date().setDate(new Date().getDate() + 8),
    className: 'bg-info text-white'
},
{
    id: 4,
    title: 'لجنة رخص البناء',
...
const DefaultCategories = [
    {
        id: 1,
        title: 'لجنة رخص البناء والتقسيمات',
        type: 'bg-primary'
    },
    {
        id: 2,
    ...
    {
        id: 3,
        title: 'لجنة الشؤون الماليّة والإقتصاديّة ',
        type: 'bg-warning'
    },
    {
        id: 4,
            ...
            <React.Fragment>
                <div className="page-content">
                    ...
                    <Container fluid={true}>
                        ...
                        {/* Render Breadcrumb */}
                        <Breadcrumbs title="معالجة" breadcrumbItem="برمجة تواريخ اللحان" />



                        <Row>
                            <Col lg={3}>
                                <Button color="secondary" outline className="font-16 text-secondary bg-white btn-rounded btn-block" onClick={this.togglecategory}>
                                    <i className="mdi mdi-plus-circle-outline"></i> إضافة لجنة
                                </Button>
                                ...
                                <div id="external-events" className="mt-3">
                                    ...
                                    {this.state.categories.map((category, i) => {
                                        return <div className={`external-event ${category.type} text-white p-2 mb-2`} key={"cat-" + category.id}
