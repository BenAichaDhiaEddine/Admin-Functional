        ...
        permits: [
            {
                ...
                status: { name: "صالحة" , color:"success"}, img: avatar2,
                request: { id:23, owner:"أحمد بن زينب", type: "إشهار", category: "ملك عمومي", date: "01.01.2019 12:00",}

            },
            {
                id: 2, date: "02.02.2019 13:00", expiration: "02.02.2020 13:00",  corporate:"حمام الأنف",
                status: { name: "منتهية" , color:"danger"}, img: "Null",
                request: { id:20, owner:"أمين السليمي", type: "بناء", category: "خاص", date: "01.01.2019 12:00",}
            ...
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        ...
                        {/* Render Breadcrumbs */}
                        <Breadcrumbs title="القائمة" breadcrumbItem="رخص" />
                                            ...
                                            <div className="table-responsive">
                                                <Table className="table-centered table-nowrap table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col" style={{ width: "70px" }}></th>
                                                        <th scope="col">الطّلب</th>
                                                        <th scope="col">نوع</th>
                                                        <th scope="col">الحالة</th>
                                                        <th scope="col">الصلوحية</th>
                                                                        ...
                                                                        permit.img === "Null"
                                                                            ? <div className="avatar-xs">
                                                                                    <span className="avatar-title bg-success rounded-circle">
                                                                                        {permit.request.owner.charAt(0)}
                                                                                    </span>
                                                                            </div>
                                                                            : <div>
                                                                                <img className="rounded-circle avatar-xs" src={permit.img} alt="" />
                                                                            </div>
                                                                    }

                                                                </td>
                                                                <td>
                                                                    <h5 className="font-size-14 mb-1"><Link to="#" className="text-dark">{permit.request.owner}</Link></h5>
